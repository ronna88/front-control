        ...
        <BlankCard>
            <Box sx={style}>
                {erase ?
                    ...
                    <>
                    <TextField value={form.ativoDescricao} onChange={handleOnChangeDescricao} sx={{width:'300px'}} id='ativoDescricao' name='ativoDescricao' label="Descrição" />
                    <TextField value={form.ativoValorCompra} onChange={handleOnChangeValorCompra} sx={{width:'300px'}} id='ativoValorCompra' name='ativoValorCompra' label="Valor de Compra" />
                    <TextField value={form.ativoValorLocacao} onChange={handleOnChangeValorLocacao} sx={{width:'300px'}} id='ativoValorLocacao' name='ativoValorLocacao' label="Valor de Locação" />
