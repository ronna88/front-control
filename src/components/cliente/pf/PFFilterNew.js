...
const PFFilterNew = ({setRows, setLoading}) => {
    ...
    return (
        ...
        <Modal
            ...
            <Box sx={style}>
                ...
                <PFForm handleOpen={handleOpen} handleClose={handleClose} setRows={setRows} setLoading={setLoading}/>
            </Box>
        </Modal>
        </>
