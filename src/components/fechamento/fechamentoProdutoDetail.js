                ...
                <table className="fechamento-detail">
                    ...
                    <td colSpan="4" style={{ height: '150px', borderBottom:'1px solid #000;', borderRight:'1px solid #fff', borderLeft:'1px solid #fff', borderTop:'1px solid #fff' }}></td> {/* Ajuste a altura conforme necessário */}
                        ...
                        <tr>
                            ...
                            <th style={{borderTop:'1px solid #000'}}>Descritivo de Visita com os PRODUTOS utilizados</th>
                    ...
                    <tbody >
                        {fechamento.visitas && fechamento.visitas.length > 0 ? (
                            fechamento.visitas.map((visita) => (
                                <tr key={visita.visitaId}>
                                    ...
                                    <td>{(visita.visitaValorProdutos).toLocaleString('pt-br',{style:'currency', currency: 'BRL'})}</td>
                                </tr>
                            ))
                        ) : (
                            <tr>
                        ...
                        <tr>
                            <td colSpan="3" align="right"><strong>Total dos Produtos Utilizados</strong></td>
                            <td>{fechamento.fechamentoValorProdutos.toLocaleString('pt-br',{style:'currency', currency: 'BRL'})}</td>
                        </tr>
