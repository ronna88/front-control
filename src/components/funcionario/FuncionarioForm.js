...
const FuncionarioForm = ({
  ...
  function formatDate(dateString) {
    // Parse a string in "dd-MM-yyyy" format and output it in "yyyy-MM-dd"
  ...
  useEffect(() => {
    if (selectedFuncionario) {
      ...
      setForm({
        ...
        funcionarioNascimento: formatDate(selectedFuncionario.funcionarioNascimento),
        ...
        funcionarioAdmissao: formatDate(selectedFuncionario.funcionarioAdmissao),
      });
    }
  }, []);
          ...
          <>
            ...
            <Box sx={{ display: 'flex', gap: 5 }}>
              <Button
                variant="contained"
                color="error"
                onClick={() => handleSim(selectedFuncionario)}
              >
                Sim
              </Button>
          ...
          <>
            <div className="formContainer">
              <div className="col-1">
                ...
                <TextField
                  type="date"
                  value={form.funcionarioNascimento}
                  onChange={handleOnChangeNascimento}
                  sx={{ width: '300px' }}
                  id="funcionarioNascimento"
                  name="funcionarioNascimento"
                />
                ...
                <TextField
                  value={form.funcionarioTelefone}
                  onChange={handleOnChangeTelefone}
                  sx={{ width: '300px' }}
              ...
              <div className="colForm">
                ...
                <TextField
                  value={form.funcionarioEndereco}
                ...
                <TextField
                  value={form.funcionarioEndereco2}
                  onChange={handleOnChangeEndereco2}
                  sx={{ width: '300px' }}
                  id="funcionarioEndereco2"
                  name="funcionarioEndereco2"
                  label="Endereço2"
                />
                <InputLabel>Bairro</InputLabel>
                <TextField
                  value={form.funcionarioBairro}
                  onChange={handleOnChangeBairro}
                  sx={{ width: '300px' }}
                  id="funcionarioBairro"
                  name="funcionarioBairro"
                  label="Bairro"
                />
                <InputLabel>CEP</InputLabel>
                <TextField
                  value={form.funcionarioCEP}
                ...
                <TextField
                  type="date"
                  value={form.funcionarioAdmissao}
                  onChange={handleOnChangeAdmissao}
                  sx={{ width: '300px' }}
                  id="funcionarioAdmissao"
                  name="funcionarioAdmissao"
                />
              </div>
            </div>
