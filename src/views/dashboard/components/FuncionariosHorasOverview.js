...
const FuncionariosHorasOverview = ({ year }) => {
  ...
  return (
    <DashboardCard
      title="Total de Horas de Visitas por Funcionário"
      action={
    ...
    >
      <Chart options={optionsBarChart} series={seriesBarChart} type="bar" height="350px" />
    </DashboardCard>
  );
};
