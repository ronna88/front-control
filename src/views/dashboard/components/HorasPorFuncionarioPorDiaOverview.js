...
const HorasPorFuncionarioPorDiaOverview = () => {
    const [month, setMonth] = React.useState(new Date().getMonth() + 1);
    const [totalHorasPorFuncionarioPorDia, setTotalHorasPorFuncionarioPorDia] = React.useState({ series: [], categories: [] });
    ...
    const colors = ['#FF5733', '#33FF57', '#3357FF', '#FF33A1', '#A133FF', '#33FFF5', '#FF8C33', '#8C33FF', '#33FF8C', '#FF3333'];
    ...
    return (
        <DashboardCard title="Total de Horas de Visitas por Funcionário por Dia" action={
            <Select
                labelId="month-dd"
                id="month-dd"
                value={month}
